...
def run_custom(v,m,theta,z,x,r,Y, planet="Earth",show =True):
    """
    input:
    ...
    #eroscode.initial_state = state
    eroscode.ensemble = False
    eroscode.main(v,m,theta,z,x,r,Y)
    final_state = eroscode.main(v,m,theta,z,x,r,Y)
    if show == True:
        plots.plot_5_graphs(final_state)
    return final_state
...
#run_asteroid(planet="Earth", asteroid = "Tunguska", show =False)
