...
def main_pre():
    ...
    if airburst_event is True:
        ...
        states_2 = solve_ivp(ode_solver_pre_burst,
                             (t_new, 1.1 * tmax), state0, t_eval=t2, method='RK45', atol=tol, rtol=tol)
...
def main_radau():
    ...
    # solving the ODE for pre-burst conditions using Radau
    states = solve_ivp(ode_solver_pre_burst, (0, 1.1 * tmax), state0, t_eval=t, method='Radau', rtol = 1E-10, atol = 1E-10)
    ...
    if airburst_event is True:
        ...
        states_2 = solve_ivp(ode_solver_post_burst,
                             (t_new, 1.1 * tmax), state0, t_eval=t2, method='Radau', rtol = 1E-10, atol = 1E-10)
